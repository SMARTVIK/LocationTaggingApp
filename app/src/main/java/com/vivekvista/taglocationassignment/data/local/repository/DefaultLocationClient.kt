...
import com.vivekvista.taglocationassignment.common.hasLocationPermission
...
/*
* ...This class is intended to get the location updates and
*
*
* */
    ...
    override fun getLocationUpdates(interval: Long): Flow<Location> {
        return callbackFlow {
            if(!context.hasLocationPermission()) {
                throw LocationClient.LocationException("Location permission not available")
            }
